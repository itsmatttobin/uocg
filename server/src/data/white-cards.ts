const whiteCards: string[] = [
  ...
  'Using a Rake.',
  'Pimms.',
  'A particular Pond Dweller.',
  'Emos.',
  'Getting Darth Mauled .',
  'Your Mums an Elephant.',
  'Mary.',
  'A massive shit in a sink.',
  'A Vintage Les Paul.',
  'Drowning it in Tears.',
  'A Dirty Pint.',
  'Somebody with a Glove on.',
  'Killogs.',
  'A Baby Yoda Fetish.',
  'A Pompus Cunt.',
  ...
  'The Leap.',
  'A Kick Me Sign.',
  'Using Jizz as Conditioner.',
  'WKD Blue.',
  'A hand puppet of Godzilla.',
  'A bowl of milk.',
  'Chicken Little.',
  'A man with no Rhythm.',
  'Julians Brownies.',
  'Injecting Bleach.',
  'That bitch, Carole Baskin.',
  'Inject disinfectant into your body.',
  'Sit on my face and tell me you love me.',
  'Donald trump’s hair.',
  'Blue waffle.',
  'Harvey Weinstein.',
  'A t-rex making love to a pig.',
  'David Cameron fucking a pig.',
  'Saying thank you with a mouth full of cum (dribble dribble).',
  'A rusty trombone.',
  'Urinating on someone to assert dominance.',
  'A naked paraplegic giving you sex eyes.',
  'Shit in my hands clap.',
  'Chey-nah.',
  '5G that\'s who!',
];
