...
const blackCards: IBlackCard[] = [
  ...
  // the Mexican government funneled millions of pesos into research on ___.',
  //   pick: 1,
  // },
  // {
  ...
  /////////////////////////////////////////////////////
  /////////////// CUSTOM GAME 29.04.20 ////////////////
  /////////////////////////////////////////////////////
  {
    text: '___ is the most hurtful inanimate object?',
    pick: 1,
  },
  {
    text: 'How does a Hobo tend to his beard?',
    pick: 1,
  },
  {
    text: 'The worst drink to have at a summer house party is ___?',
    pick: 1,
  },
  {
    text: '___ has a ribbed hand.',
    pick: 1,
  },
  {
    text: '___ is the most cheerful Cereal.',
    pick: 1,
  },
  {
    text: 'What is the Mandalorian\'s big turn on?',
    pick: 1,
  },
  {
    text: 'The new way to cure coronavirus is ___.',
    pick: 1,
  },
  {
    text: 'Where did they find Madeleine McCann?',
    pick: 1,
  },
  {
    text: 'How do I assert dominance?',
    pick: 1,
  },
  {
    text: 'Today kids! We’ll be learning about ___.',
    pick: 1,
  },
  {
    text: 'No grandad! You cannot ___.',
    pick: 1,
  },
  {
    text: '___. That is how I like my coffee in the morning!',
    pick: 1,
  },
  {
    text: 'Kobe\'s last thought.',
    pick: 1,
  },
  {
    text: 'Before we have sexual intercourse, we must ___.',
    pick: 1,
  },
  {
    text: 'When I met the Boris Johnson he told me ___.',
    pick: 1,
  },
  {
    text: 'How did I catch coronavirus?',
    pick: 1,
  },
];
